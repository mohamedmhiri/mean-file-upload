...
const app = express();
app.use(cors());
app.post('/image', upload.single('image'), (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
...
app.post('/images', upload.array('images', 12), (req, res) => __awaiter(this, void 0, void 0, function* () {
    try {
        const col = yield utils_1.loadCollection(COLLECTION_NAME, db);
